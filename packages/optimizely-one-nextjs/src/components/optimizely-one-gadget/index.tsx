...
export const OptimizelyOneGadget : FunctionComponent<OptimizelyOneGadgetProps> = ({ servicePrefix = "/api/me", refreshInterval = 0, show = undefined }) =>
{
    ...
    return <Popover className="oo-gadget md:oo-fixed md:oo-bottom-0 oo-z-[500]">
        ...
        <PopoverPanel className="oo-fixed oo-bottom-[50px] oo-right-0 oo-w-full oo-top-0 md:oo-border md:oo-border-slate-300 oo-bg-white md:oo-right-4 md:oo-bottom-[55px] md:oo-w-[600px] oo-z-[501] oo-max-w-full oo-flex oo-flex-col oo-justify-stretch md:oo-h-[350px] md:oo-top-auto md:oo-rounded-md md:oo-shadow-xl md:oo-overflow-hidden oo-text-slate-800 dark:oo-text-slate-800">
