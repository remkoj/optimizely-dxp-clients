...
export const OptimizelyOneGadget : FunctionComponent<OptimizelyOneGadgetProps> = ({ servicePrefix = "/api/me", refreshInterval = 0, show = undefined }) =>
{
    ...
    return <Popover className="oo-gadget md:oo-fixed md:oo-bottom-0 oo-z-[500]">
        <PopoverButton className='oo-fixed oo-bottom-0 oo-right-0 oo-w-full oo-h-[50px] oo-flex oo-flex-row oo-justify-between oo-p-2 oo-border-t oo-border-slate-500 oo-bg-slate-100 oo-text-slate-800 md:oo-w-[350px] md:oo-right-4 md:oo-rounded-t-md md:oo-border-x oo-z-[500] oo-p-[10px]'>
        ...
        <PopoverPanel className="oo-fixed oo-bottom-[50px] oo-right-0 oo-w-full oo-top-0 md:oo-border md:oo-border-slate-300 oo-bg-white md:oo-right-4 md:oo-bottom-[55px] md:oo-w-[600px] oo-z-[501] oo-max-w-full oo-flex oo-flex-col oo-justify-stretch md:oo-h-[350px] md:oo-top-auto md:oo-rounded-md md:oo-shadow-xl md:oo-overflow-hidden">
