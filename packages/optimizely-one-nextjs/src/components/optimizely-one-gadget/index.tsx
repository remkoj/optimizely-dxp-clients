...
}: OptimizelyOneGadgetProps) =>
{
    ...
    if (show || (show === undefined && HelperEnabled))
    {
        return <Suspense fallback={null}>
            <OptimizelyOneClientGadget refreshInterval={refreshInterval} servicePrefix={servicePrefix} show={show} showContentRecs={ productStatus.contentRecsApi } showDataPlatform={ productStatus.dataPlatform } showWebEx={ productStatus.webExperimentation } />
        </Suspense>
    }
