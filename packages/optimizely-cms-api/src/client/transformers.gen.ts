...
export const changesetsPatchItemResponseTransformer = async (data: any): Promise<ChangesetsPatchItemResponse> => {
    data = changesetItemSchemaResponseTransformer(data);
    return data;
};
...
const compositionDisplaySettingsSchemaResponseTransformer = async (data: any) => { return data }
const contentReferenceSchemaResponseTransformer = async (data: any) => { return data }
