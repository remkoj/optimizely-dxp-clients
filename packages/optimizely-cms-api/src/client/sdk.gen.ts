 ...
 */
export const contentGetPreviews = <ThrowOnError extends boolean = false>(options: Options<ContentGetPreviewsData, ThrowOnError>) => (options.client ?? client).get<ContentGetPreviewsResponses, ContentGetPreviewsErrors, ThrowOnError>({ url: '/experimental/content/{key}/versions/{version}/previews', ...options });
